...
public class Admin implements Sueldo{
    ...
    public Admin(String nombre, String apellido_Completo, int DNI, int año, int sueldo, String afiliacion, double sueldob) {
        this.nombre = nombre;
    ...
    public Admin(int sueldo, String afiliacion) {
        this.sueldo = sueldo;
        this.afiliacion = afiliacion;
    }
